...
ActiveRecord::Schema.define(version: 2021_07_12_181054) do
  ...
  create_table "interventions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.decimal "author", precision: 10
    t.decimal "customerID", precision: 10
    t.decimal "buildingID", precision: 10
    t.decimal "batteryID", precision: 10
    t.decimal "columnID", precision: 10
    t.decimal "elevatorID", precision: 10
    t.decimal "employeeID", precision: 10
